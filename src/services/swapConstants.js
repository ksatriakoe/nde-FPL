...
export const stakingAbi = [
    ...
    'function getStakeInfo(address account) external view returns (uint256 _totalStaked, uint256 _userStaked, uint256 _userRewards, uint256 _rewardPool, uint256 _minStake, uint256 _apy)',
